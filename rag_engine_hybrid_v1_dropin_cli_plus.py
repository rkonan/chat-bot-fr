...
if __name__ == "__main__":
    ...
    p.add_argument("--model_name", type=str, default=os.getenv("LLM_MODEL", "qwen2.5:3b"), help="LLM model name for Ollama generation")
...
if __name__ == "__main__":
    ...
    p.add_argument("--model_name", type=str, default=os.getenv("LLM_MODEL", "qwen2.5:3b"), help="Ollama LLM model for generation")
    p.add_argument("--ollama_host", type=str, default=os.getenv("OLLAMA_HOST", "http://localhost:11434"), help="Ollama host URL")
    p.add_argument("--ollama_timeout", type=int, default=int(os.getenv("OLLAMA_TIMEOUT", "120")), help="Ollama HTTP timeout (s)")
